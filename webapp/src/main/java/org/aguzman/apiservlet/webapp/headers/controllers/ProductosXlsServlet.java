...
public class ProductosXlsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (esXls) {
            resp.setContentType("applications/vnd.ms-excel");//Se modifica el tipo de contenido del response para poder exportar a un excel
            resp.setHeader("Content-Disposition", "attachment;filename=producto.xls");//Se coloca el nombre del archivo y se fuerza la descarga
        }
